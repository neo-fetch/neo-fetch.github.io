        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-5 md:gap-8">
          ...
          <div className="col-span-1 md:col-span-3">
            <div className="space-y-8">
              ...
              >
                Embedding futuristic capabilities to present-day solutions
              </TextReveal>
              <TextReveal
                as="p"
                className="text-muted-foreground text-base leading-relaxed sm:text-lg md:text-lg lg:text-xl xl:text-2xl"
              >
                I aspire to revolutionize the technological landscape by crafting innovative solutions that leverage deep learning, transformers, and Physics-Informed Neural Networks (PINNs). By applying these cutting-edge methodologies to modern-day challenges, I aim to address complex problems through cutting-edge research in Structural Equation Modeling (SEM) and other advanced statistical approaches, pushing the boundaries of what is possible.
              </TextReveal>
